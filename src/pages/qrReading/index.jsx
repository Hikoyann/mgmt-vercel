...
//     try {
//       const model = await tf.loadGraphModel("/models/yolo/model.json"); // YOLOのモデルパス
//       setModel(model);
...
//     ctx.clearRect(0, 0, canvas.width, canvas.height); // 描画を初期化

//     boxes.forEach((box, i) => {
//       if (scores[i] > 0.5 && classes[i] === 0) {
//         // QRコードクラスID (YOLOのクラスIDを適切に設定)
...
//     const interval = setInterval(detectObjects, 500); // 500msごとに物体検出
